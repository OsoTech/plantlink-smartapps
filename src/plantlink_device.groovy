...
metadata {
    definition (name: "PlantLink", namespace: "OsoTech", author: "Oso Technologies") {
        ...
        fingerprint profileId: "0104", inClusters: "0001,0B04"
    }
    ...
    tiles {
        ...
        valueTile("plantFuelLevelTile", "device.plantFuelLevel", width: 1, height: 1) {
            state("plantFuelLevel", label: '${currentValue}% Fuel')
        }
        ...
        details(['plantStatusTextTile', "plantFuelLevelTile", "battery", "installSmartApp"])
    }
}
